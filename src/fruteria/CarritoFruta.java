   ...
   Ventas venta = new Ventas();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(jTableProducto.getSelectedRow()>=0){
                System.out.println(modelo.getValueAt(0, 0));
                String seleccionTxt=""+modelo.getValueAt(jTableProducto.getSelectedRow(),jTableProducto.getSelectedColumn());
                if(!seleccionTxt.equals("null")){
                    //Arreglo de frutas
                    String[] frutas=new String[6];
                    for(int i=0;i<6;i++){
                        frutas[i]=modelo.getValueAt(jTableProducto.getSelectedRow(),i).toString();
                        System. out. println("Esto sale en pantalla\n");
                    }
                   EditarFrutas a= new EditarFrutas();
        a.setVisible(true);
